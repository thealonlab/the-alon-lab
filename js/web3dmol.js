/* example: https://web3dmol.net/example/1.html */ 
var w3m_official = 'https://web3dmol.net/';
...
w3m = {
    ...
    /* URL */
    url : [ 'https://files.rcsb.org/view/', 'https://www.rcsb.org/pdb/files/' ],
...
w3m.ajax = (function() {
    ...
    io.get = function(source, fn) {
        callback = fn;
        if ( w3m_start_with('source', 'http') ) {
            url = source;
            url_parts = source.split('/');
            id = url_parts[url_parts.length-1].split('.')[0];
        } else {
            id  = source;
            url = w3m.url[url_index] + source + '.pdb';
        }
...
w3m.pdb = function ( source ) {
    ...
    var loadFromURL = function ( source ) {
        w3m.ajax.get(source, function(response) {
            text = response;
            parse();
        });
    }
...
w3m.ui = {
                    ...
                    if ( w3m_isset(chain[ii]) ) {
                        ...
                        switch ( ss ) {
                            ...
                            case w3m.HELIX_HEAD :
                                s += '<td class="' + td_class + '">'
                                  +    '<div class="w3m-seqplot-residue" title="'+residue_title+'" token="'+residue_token+'">' + residue_info[0] + '</div>'
                                  +    '<div class="w3m-seqplot-ss w3m-seqplot-helix-head '+chain_class+' '+ss_id+'" title="Î±-Helix\n'+ss_title+'" token="'+ss_token+'"></div>'
                                  +  '</td>';
                                break;
                            case w3m.HELIX_BODY :
                                s += '<td class="' + td_class + '">'
                                  +    '<div class="w3m-seqplot-residue" title="'+residue_title+'" token="'+residue_token+'">' + residue_info[0] + '</div>'
                                  +    '<div class="w3m-seqplot-ss w3m-seqplot-helix-middle '+chain_class+' '+ss_id+'" title="Î±-Helix\n'+ss_title+'" token="'+ss_token+'"></div>'
                                  +  '</td>';
                                break;
                            case w3m.HELIX_FOOT :
                                s += '<td class="' + td_class + '">'
                                  +    '<div class="w3m-seqplot-residue" title="'+residue_title+'" token="'+residue_token+'">' + residue_info[0] + '</div>'
                                  +    '<div class="w3m-seqplot-ss w3m-seqplot-helix-foot '+chain_class+' '+ss_id+'" title="Î±-Helix\n'+ss_title+'" token="'+ss_token+'"></div>'
                                  +  '</td>';
                                break;
                            case w3m.SHEET_HEAD :
                                s += '<td class="' + td_class + '">'
                                  +    '<div class="w3m-seqplot-residue" title="'+residue_title+'" token="'+residue_token+'">' + residue_info[0] + '</div>'
                                  +    '<div class="w3m-seqplot-ss w3m-seqplot-sheet-head '+chain_class+' '+ss_id+'" title="Î²-Sheet\n'+ss_title+'" token="'+ss_token+'"></div>'
                                  +  '</td>';
                                break;
                            case w3m.SHEET_BODY :
                                s += '<td class="' + td_class + '">'
                                  +    '<div class="w3m-seqplot-residue" title="'+residue_title+'" token="'+residue_token+'">' + residue_info[0] + '</div>'
                                  +    '<div class="w3m-seqplot-ss w3m-seqplot-sheet-middle '+chain_class+' '+ss_id+'" title="Î²-Sheet\n'+ss_title+'" token="'+ss_token+'"></div>'
                                  +  '</td>';
                                break;
                            case w3m.SHEET_FOOT :
                                s += '<td class="' + td_class + '">'
                                  +    '<div class="w3m-seqplot-residue" title="'+residue_title+'" token="'+residue_token+'">' + residue_info[0] + '</div>'
                                  +    '<div class="w3m-seqplot-ss w3m-seqplot-sheet-foot '+chain_class+' '+ss_id+'" title="Î²-Sheet\n'+ss_title+'" token="'+ss_token+'"></div>'
                                  +  '</td>';
                                break;
                            case w3m.CHAIN_NA :
                                s += '<td class="' + td_class + '">'
            ...
            ms_array.forEach(function(ms) {
                ...
                switch ( ms.type ) {
                    case w3m.MEASURE_DISTANCE : 
                        ...
                        if ( point.a && point.b ) {
                            ms.result    = vec3.dist(point.a, point.b).toFixed(4) + ' Ã…';
    ...
    tool : {
        shareDialog : function () {
            ...
            url        = 'https://' + location.host + location.pathname + '?id=' + mol_id + ( url_string ? '&' + url_string : '');
    ...
    info : {
        ...
        sidebox : function () {
            ...
            if ( info.cell ) {
                s += this.html_helper('Unit Cell', 'a : '+info.cell.len[0]+'Ã…, b : '+info.cell.len[1]+'Ã…, c : '+info.cell.len[2]+'Ã…');
                s += this.html_p('Î± : '+info.cell.angle[0]+'Â°, Î² : '+info.cell.angle[1]+'Â°, Î³ : '+info.cell.angle[2]+'Â°');
            ...
            s += this.html_helper('Links', '<a href="https://www.rcsb.org/pdb/explore/explore.do?structureId=' + info.id + '" target="_blank">[ RCSB ]</a>' + (info.pmid ? '<span class="w3m-hsp"></span><a href="https://www.ncbi.nlm.nih.gov/pubmed/' + info.pmid + '" target="_blank">[ PubMed ]</a>' : '') + (info.doi ? '<span class="w3m-hsp"></span><a href="https://dx.doi.org/' + info.doi + '" target="_blank">[ DOI ]</a>' : ''));
            s += '</div>'; // end sidebox-body
            s += '</div>'; // end sidebox
...
w3m.api = {
    ...
    fragment_set : function ( fg_id, rep_mode, color_mode, label_area, label_content, color_defined ) {
        ...
        fg.defined_color = 1300 + fg_id;
        // this.color( 1300 + fg_id, color_defined || w3m.rgb[1] );
        w3m.rgb[fg.defined_color] = color_defined || w3m.rgb[1];
